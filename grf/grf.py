...
class NewGRF(BaseNewGRF):
    ...
    def add_bool_parameter(self, *, key, name, description, default=None, mapping=None):
        data = {
            'NAME': name,
            'DESC': description,
            'TYPE': b'\x01',
    ...
    def add_int_parameter(self, *, key, name, description, default=None, limits=None, enum=None, mapping=None):
        data = {
            'NAME': name,
            'DESC': description,
            'TYPE': b'\0',
